...
class LidarRadarFusion:
    def __init__(self):
        ...
        # Parameters
        radar_detections_topic = rospy.get_param("~in_radar_detections_topic", 'radar/tracked_objects')
        lidar_detections_topic = rospy.get_param("~in_lidar_detections_topic", 'lidar/tracked_objects')
        marker_array_topic = rospy.get_param("~out_marker_array_topic", 'detected_polygons')
        detected_object_array_topic = rospy.get_param("~out_tracked_objects", 'tracked_objects')
